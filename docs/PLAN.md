...
| P0 | done | docs配下の整理方針作成 | `docs/DOCS_STRUCTURE.md` を作成 | 2026-06-20 ✓ |
| P0 | done | legacy docs棚卸し | `docs/LEGACY_DOCS_INVENTORY.md` を作成 | 2026-06-20 ✓ |
| P0 | doing | Atlas導線確認 | `integrated-system-atlas` のContext Packへリンク確認 | 2026-06-21 |
...
| P1 | REVIEW_REQUIRED | legacy docs実移動判断 | `docs/99_archive/legacy-imports/` へ移すか判断 | 未定 |
...
- ✓ docs配下の現行/legacy分離方針を作成
- ✓ `revi.mypressonline.com/` と `rsfdb.suyalist.com/` のlegacy docs棚卸しを作成
...
| 2026-06-20 | docs構造・legacy docs棚卸し完了 |
...
- legacy docsを移動/昇格する前に `docs/LEGACY_DOCS_INVENTORY.md` の秘密情報ガイドラインを確認する
